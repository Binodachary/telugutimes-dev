...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9191323709031905" crossorigin="anonymous"></script>
<!-- Top_TT_main_header -->
<ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-9191323709031905" data-ad-slot="7567223856"></ins>
<script>
  ...
  <div class="container mx-auto">
    <div class="lg:w-9/12 mx-auto flex items-center justify-between">
      ...
      <div class="header-logo  hidden md:block md:w-1/3">
        <a href="index.php" class="block"><img src="/images/logo.png" class="max-w-full h-23" alt="Telugu Times News"></a>
      </div>

      <!-- Header Banner -->
      <div class="header-banner md:w-2/3">
        <div class="banner">
          @if(!empty($ads['logo-top-right-full']))
          @foreach($ads['logo-top-right-full'] as $ad)
          <a href="{{ $ad->url }}" target="_blank" class="block" title="{{ $ad->name }}">
