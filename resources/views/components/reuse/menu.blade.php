<nav v-click-outside="closeSidebar" :class="{'lg:fixed lg:top-0 lg:w-full': stickyHeader }" style="background-color:#224893;" class="border-b w-full z-10">
    ...
    <div :class="{'translate-x-0': open, '-translate-x-full': ! open}" v-cloak class="bg-blue-500 divide-black divide-solid divide-y fixed inset-y-0 left-0 lg:hidden transform-gpu z-10 transition w-full duration-300 ease-linear" style="margin-top: 155px;">
