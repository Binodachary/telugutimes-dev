...
<header id="header">
    <!--    <x-header-ads/>-->
    <div class="logo-wrapper flex lg:flex-nowrap flex-wrap md:flex-row items-center lg:space-x-2">
        <div class="lg:w-3/12 w-9/12 order-1">
            <a href="/" class="block"> <img src="/images/tt_logo.png" class="w-56 lg:w-full mx-auto" alt="Logo"> </a>
        </div>
        <div class="lg:w-7/12 w-full lg:order-2 order-3">
            <img src="https://via.placeholder.com/840x95?text=Advertisement" class="my-2 mx-auto" alt="advertisement">
        </div>
        <div class="lg:w-2/12 w-3/12 lg:order-3 order-2">
            <a href="#" target="_blank" class="block" title="">
                <img class="w-full object-cover" src="http://hostingmanager.xyz/images/medium/advertisements/pTKBakn2l9ZXwYBo496qTxC1I3Oflh1f8i1t2UkD.gif" alt="">
            </a>
        </div>
    </div>
    <div class="special-menu-items flex flex-wrap space-y-2 pb-2 justify-center items-baseline space-x-1 lg:justify-between">
        ...
        <a class="bg-blue-600 inline-flex lg:mb-0 text-xs text-white xl:text-sm xl:font-bold my-2 px-2 py-1 rounded-md hover:text-yellow-400 transition ease-in duration-300" href="{{ route('gallery.category','america') }}" target="_blank">
            NRI Galleries </a>
        <a class="bg-blue-600 lg:inline-flex hidden lg:mb-0 text-xs text-white xl:text-sm xl:font-bold px-2 py-1 rounded-md hover:text-yellow-400 transition ease-in duration-300" href="{{ route('nats-pdf') }}" target="_blank">
            NATS Sevalu in Covid Period (eBook) </a>
        <a class="bg-blue-600 lg:inline-flex hidden lg:mb-0 text-xs text-white xl:text-sm xl:font-bold px-2 py-1 rounded-md hover:text-yellow-400 transition ease-in duration-300" href="{{ route('tana-pdf') }}" target="_blank">
