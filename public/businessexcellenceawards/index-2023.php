					...
					<div class="col-lg-6 col-md-6 col-sm-12 mb-md-0 mb-4 text-center">
						...
						<div id="main">
							<div class="d-flex justify-content-center flex-column h-100" data-aos="fade-up">
								...
								<p class="text-white banner-paragraphtt text-justify">
									A First of its kind event with an objective of identifying and awarding Telugu Entrepreneurs operating in the USA and who have achieved exceptional success and made a positive impact in their industries and communities.
								</p><p></p><!--a href="bea23.php"><img src="assets/images/thanks.jpg" style="height:405px"></a-->
								<!--h5> SAN JOSE, California | Saturday, 24 June 23</h5><p></p><p></p>
								<a href=partners.php><p><img class="img-fluid banner-img-width" src="assets/images/indexpg_partners.png"
										 style="width: 540px;" alt="Partners for Business Excellence Awards"/></p><p></p><p></p>
								<p style="padding-top:45px;"><img class="img-fluid banner-img-width" src="assets/images/indexpg_cpartners.png"
										 style="width: 522px; height:99px;" alt="Partners for Business Excellence Awards"/></p>
								<p class="text-right text-white" data-aos="fade-left" style="padding-right:27px;">More Partners ...</p></a-->									 
							</div>
						</div>
					</div>
