                            ...
                            <div class="about-us-section-page" data-aos="fade-up" style="padding:54px 27px 54px 27px">
                               <div class="row">
								...
								<div class="col-lg-9 col-md-9 col-sm-12 text-center" style="padding-left:36px; padding-right:0px;"> 
									...
									<h4 class="text-white artificial-text">A FIRST OF ITS KIND EVENT TO CELEBRATE TELUGU ENTREPREURSHIP</h4><br><Br>									
									<div class="container"><div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 mb-md-0 mb-4 text-center text-white" style="padding-top:36px"><center>THE BEA '23 EVENING</div>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 mb-md-0 mb-4 text-center text-white"><center>
											<div class="about-us-content" style="padding:0px; margin:0px; width:144px; height:108px" data-aos="fade-up">
												<p class="security-services-p" align="center"><br><b>SOCIAL HOUR</b><br>4:30 PM - 5:30 PM</p>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 mb-md-0 mb-4 text-center text-white"><center>
											<div class="about-us-content" style="padding:0px; margin:0px; width:108px; height:108px" data-aos="fade-up">
										...
										<div class="col-lg-3 col-md-3 col-sm-6 mb-md-0 mb-4 text-center text-white"><center>
											<div class="about-us-content" style="padding:0px; margin:0px; width:144px; height:108px" data-aos="fade-up">
												<p class="security-services-p" align="center">KEY NOTE ADDRESS<br>
												<b style="padding-top:18px">Mr Bhaskara Sunkara</b><br>Building and scaling up businesses</p>
											</div>
										</div>
									...
									Registration</a> ONLY (Submit Below)</h4><!--p class="text-white banner-paragraphtt">(Dress Code: Formals/ Business Casuals)</p-->
								</div>
                               </div>
                            </div>
                        </div>
